package org.tensorflow.lite.examples.objectdetection.ml;
 ...
 */
public final class Drowiness {
  @NonNull
  private final Model model;

  private Drowiness(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "drowiness.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Drowiness newInstance(@NonNull Context context) throws IOException {
    return new Drowiness(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Drowiness newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Drowiness(context, options);
  }
